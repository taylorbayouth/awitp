...
namespace UltimateProceduralPrimitives
{
  ...
  {
    public MyMeshInfo CalculateMyMeshInfo(PyramidFlexParameters parameter)
    {
      ...
      var myMeshInfo_forwardPlane = new FormulaPlaneFlex().CalculateMyMeshInfo(forwardPlaneParameter);
      var myMeshInfo_backwardPlane = new FormulaPlaneFlex().CalculateMyMeshInfo(backwardPlaneParameters);
